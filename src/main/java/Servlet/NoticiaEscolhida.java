...
public class NoticiaEscolhida extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("NoticiaEscolhida123", noticia);
            ...
            {
                RequestDispatcher view = request.getRequestDispatcher("Noticia2.jsp");
                view.forward(request,response);
            }
        } finally {
            out.close();
